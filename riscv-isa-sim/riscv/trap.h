...
DECLARE_MEM_TRAP(CAUSE_MPKEY_MISMATCH_FAULT, mpkey_mismatch)
DECLARE_MEM_TRAP(CAUSE_ENCLAVE_ACCESS_FAULT, enclave_access)
DECLARE_MEM_TRAP(CAUSE_MEID_MISMATCH_FAULT, meid_mismatch)
DECLARE_MEM_TRAP(CAUSE_HPCE_FAULT, hpce)
DECLARE_TRAP(CAUSE_SATP_MODE_CHANGE, satp_mode_change)
DECLARE_MEM_TRAP(CAUSE_ENC_INTEGRITY_FAULT, enc_integrity_fault)
