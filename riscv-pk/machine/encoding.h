...
#define MATCH_MTRAP 0x7b
#define MASK_MTRAP  0x707f
#define MATCH_RDTLB 0x307b
#define MASK_RDTLB  0x707f
#define MATCH_RITLB 0x407b
#define MASK_RITLB  0x707f
#define MATCH_FENCE_T 0xb
#define MASK_FENCE_T  0x7f
...
#define CSR_UIP 0x44
#define CSR_U_TAG_SIZE 0x66
#define CSR_U_TAG_MODE 0x67
#define CSR_U_TAG_STORAGE_BASE 0x68
#define CSR_U_MPKEY_CONFIG 0x69
#define CSR_U_EAM 0x70
#define CSR_U_MEID 0x71
#define CSR_U_TLB_SIZE 0x72
#define CSR_U_EMP 0x73
#define CSR_U_TCS 0x74
#define CSR_U_TAG_CONTROL 0x75
#define CSR_U_TAG_DRAM_BASE 0x76
...
#define CAUSE_MPKEY_MISMATCH_FAULT 0x19
#define CAUSE_ENCLAVE_ACCESS_FAULT 0x1a
#define CAUSE_MEID_MISMATCH_FAULT 0x1b
#define CAUSE_ENC_INTEGRITY_FAULT 0x1c
#define CAUSE_SATP_MODE_CHANGE 0x1d
#define CAUSE_ST_IMM_FAULT 0x1e
#define CAUSE_HPCE_FAULT 0x1f
#endif
#ifdef DECLARE_INSN
...
DECLARE_INSN(mtrap, MATCH_MTRAP, MASK_MTRAP)
DECLARE_INSN(rdtlb, MATCH_RDTLB, MASK_RDTLB)
DECLARE_INSN(ritlb, MATCH_RITLB, MASK_RITLB)
DECLARE_INSN(fence_t, MATCH_FENCE_T, MASK_FENCE_T)
...
DECLARE_CSR(u_tag_size, CSR_U_TAG_SIZE)
DECLARE_CSR(u_tag_mode, CSR_U_TAG_MODE)
DECLARE_CSR(u_tag_storage_base, CSR_U_TAG_STORAGE_BASE)
DECLARE_CSR(u_mpkey_config, CSR_U_MPKEY_CONFIG)
DECLARE_CSR(u_eam, CSR_U_EAM)
DECLARE_CSR(u_meid, CSR_U_MEID)
DECLARE_CSR(u_tlb_size, CSR_U_TLB_SIZE)
DECLARE_CSR(u_emp, CSR_U_EMP)
DECLARE_CSR(u_tcs, CSR_U_TCS)
DECLARE_CSR(u_tag_control, CSR_U_TAG_CONTROL)
DECLARE_CSR(u_tag_dram_base, CSR_U_TAG_DRAM_BASE)
...
DECLARE_CAUSE("mpkey mismatch fault", CAUSE_MPKEY_MISMATCH_FAULT)
DECLARE_CAUSE("enclave access fault", CAUSE_ENCLAVE_ACCESS_FAULT)
DECLARE_CAUSE("meid mismatch fault", CAUSE_MEID_MISMATCH_FAULT)
DECLARE_CAUSE("enc integrity fault", CAUSE_ENC_INTEGRITY_FAULT)
DECLARE_CAUSE("satp mode change", CAUSE_SATP_MODE_CHANGE)
DECLARE_CAUSE("st imm fault", CAUSE_ST_IMM_FAULT)
DECLARE_CAUSE("hpce fault", CAUSE_HPCE_FAULT)
#endif
